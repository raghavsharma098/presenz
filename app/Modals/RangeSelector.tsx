    ...
    <View style={styles.overlay}>
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.headerText}>Unlock Radius</Text>
            ...
            return (
              ...
              >
                <View style={styles.leftSection}>
                  ...
                  <View style={styles.textColumn}>
                    <View style={styles.row}>
                      ...
                      <Text style={[styles.tierText, { color: item.tierColor || '#666' }]}>
                        {item.tier}
                      </Text>
                    </View>
                ...
                <View style={styles.rightSection}>
                  ...
                  <Text style={[styles.priceText, item.color ? { color: item.color } : null]}>
                    {item.price}
                  </Text>
                </View>
              </TouchableOpacity>
