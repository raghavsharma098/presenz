...
import { View, Text, StyleSheet, ImageBackground, Dimensions, TouchableOpacity, SafeAreaView } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  slideContainer: { flex: 1, justifyContent: 'space-between', paddingBottom: 40 },
